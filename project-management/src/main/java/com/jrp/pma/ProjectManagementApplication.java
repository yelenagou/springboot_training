...
//If you add scanBasePackages parameter, you must list all the parameters, even the default one
@SpringBootApplication(scanBasePackages = {"com.jrp.pma","com.yg.utils"})
